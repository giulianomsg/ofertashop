...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 14/10/2025 às 03:21
...
INSERT INTO `admins` (`id`, `nome`, `email`, `senha_hash`, `avatar`) VALUES
(1, 'Giuliano Moretti', 'giulianomsg@gmail.com', '$2y$10$46dv7tF4/F8bAyQSDECsY.OdUk.9rSreZU69VTp7Pf3464CIi6P0C', NULL),
(2, 'Amanda Sagres', 'amandacsagres@gmail.com', '$2y$10$bxICzRng6BpxK5uZRswI0.5HTjGtNuF3PuVz7HobSUEqlDkxOYunS', NULL);
...
--
ALTER TABLE `comentarios`
  ADD CONSTRAINT `comentarios_ibfk_1` FOREIGN KEY (`oferta_id`) REFERENCES `ofertas` (`id`);
