      ...
      <?php if (count($imagens)): ?>
        <div id="carouselProduto" class="carousel slide" data-bs-ride="carousel">
          ...
          <?php if (count($imagens) > 1): ?>
            <button class="carousel-control-prev" type="button" data-bs-target="#carouselProduto" data-bs-slide="prev" aria-label="Anterior">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#carouselProduto" data-bs-slide="next" aria-label="Próximo">
              <span class="carousel-control-next-icon" aria-hidden="true"></span>
            </button>
          <?php endif; ?>
        </div>
      <?php else: ?>
        <img src="<?= htmlspecialchars($oferta['imagem_url']) ?>" loading="lazy" class="img-fluid rounded" alt="Imagem do produto">
      <?php endif; ?>
    </div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content bg-dark text-white text-center">
      <div class="modal-body">
        <img src="" id="imgZoom" class="modal-img" alt="Imagem ampliada do produto">
      </div>
    </div>
  </div>
</div>
